...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="867" valign="top"><p><strong>Post Your Complaint</strong></p>
      <form name="form1" onSubmit="return abc()" method="post" action="complaint2.php">
    <?php
	$s1=$_POST["t1"];
	...
	?>    <table width="863" border="0">
          ...
          <tr>
			...
			$s="insert into complaint(cmpno,indid,complaint,cmpdate) values($cmpno,'$indid','$s1','$cmpdate')";
			mysql_query($s);
