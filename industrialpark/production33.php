...
<table width="1293" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	?>  <table width="300" border="0">
        ...
        <tr>
          <td>Get Qty </td>
          <td><input name="t2" type="text" id="t2"><?php echo $unit; ?></td>
        </tr>
        <tr>
    ...
    <td width="15">&nbsp;</td>
    <td width="422" rowspan="2" valign="top"><?php
	$k=0;
	$s="delete from temp where itemno=$s11";
	mysql_query($s);
	$s="update temp set itemno=itemno-1 where itemno>$s11";
	mysql_query($s);
