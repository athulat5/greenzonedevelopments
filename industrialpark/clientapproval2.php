...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="344" rowspan="2" valign="top"><p><strong>Apply Approval</strong></p>
      <form name="form3" onSubmit="return abc()" method="post" action="clientapproval3.php">
        <table width="341" border="0">
          <tr>
            <td>Status</td>
            <td><input name="r1" type="radio" value="Y" checked>
              Yes 
              <input name="r1" type="radio" value="N">
              No</td>
          </tr>
          <tr>
          ...
          <tr>
            <td colspan="2"><input type="submit" name="Submit3" value="Submit"><?php echo "<input type='hidden' name='t1' value='$s1'>"; ?></td>
          </tr>
        </table>
      </form>      <p>&nbsp;</p></td>
    <td width="142">&nbsp;</td>
