...
<table width="1292" border="0" cellpadding="0" cellspacing="0">
  <!--DWLayoutTable-->
  <tr>
    <td width="442" rowspan="2" valign="top"><p><strong>Order Products </strong><?php
	...
	?>
    &nbsp; </p>      </td>
    <td width="266" rowspan="2" valign="top"><p><strong>Selected Product Details</strong></p>
     <?php
       ...
       <table width="266" border="0">
         ...
         <tr>
           <td colspan="2"><div align="center">
            <?php
			$s="delete from temp1 where itemno=$s2";
			mysql_query($s);
			$s="update  temp1 set itemno=itemno-1 where itemno>$s2";
			mysql_query($s);
			/*
			$s=mysql_query("Select * from temp1 where pid='$s1'");
			if(mysql_num_rows($s)>0)
			  echo "<b><font color='red'>This Product Already Select...Remove from cart and Add Again";
			  else
			  {
			$itemno=0;
			...
			$itemno++;
			$s="insert into temp1 values($itemno,'$s1','$pname','$price','$gst',$s2,$total)";
			mysql_query($s);
			}
			*/
			?></div></td>
     ...
     <p>&nbsp; </p></td>
    <td width="235" height="27">&nbsp;</td>
    <td width="12">&nbsp;</td>
    <td width="324">&nbsp;</td>
    <td width="13">&nbsp;</td>
  </tr>
  <tr>
    <td height="317" valign="top"><?php echo "<img src='./products/$pic' width='200' height='200'>";  ?>&nbsp;</td>
    <td>&nbsp;</td>
    <td valign="top"><p>
          <script>
	function abc()
    ...
    <form name="form2" method="post" action="order4.php">
     <?php if($a>0){?> <input type="submit" name="Submit" value="Payment Gateway"><?php } ?>
    </form>    <p>&nbsp;</p>
    <p>&nbsp;</p>    <p>&nbsp; </p></td>
    <td>&nbsp;</td>
  </tr>
