...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	$s1=$_POST["t1"];
		$s2=$_POST["t2"];
	$s=mysql_query("select * from complaint  where indid is not null and reply is null and cmpno<>$s1");
	if(mysql_num_rows($s)==0)
	  echo "<b> No more Complaint waiting for Reply...";
	  else
	  {
	...
	return(false);
      ...
      <table width="412" border="0">
        ...
        <tr>
          <td><textarea name="t2" cols="40" rows="10" id="t2"><?php echo $s2; ?> </textarea></td>
        </tr>
        <tr>
          <td><?php
