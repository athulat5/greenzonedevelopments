...
<table width="1308" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="23"></td>
    <td rowspan="2" valign="top"><p><strong>Accepted Applicants  Details</strong></p>
    <p><?php
	include("connection.php");
	$s=mysql_query("select * from application  where applno in(select applno from applresponse where respstatus='Y')");
	if(mysql_num_rows($s)==0)
	 echo "<b>No Accepted Applicants";
	 else
	 {
