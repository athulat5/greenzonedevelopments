...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="28"></td>
    <td rowspan="2" valign="top"><p class="style1">Rejected Clients  List</p>
    <p>
      <?php
	...
	$s=mysql_query("select * from clientappln where indid='$indid' and clientid in(select clientid from clientapproval where appstatus='N')");
	if(mysql_num_rows($s)==0)
	 echo "<b>No Rejected Clients Found...";
	 else
	 {
