...
<table width="1297" border="0" cellpadding="0" cellspacing="0">
  ...
  <script>
	function aaa()
	{
	if(document.form3.t3.value==""|| document.form3.t4.value=="" )
	{
    ...
    <form name="form3" onSubmit="return aaa()" method="post" action="applresponse5.php">
      <table width="281" border="0">
        <tr>
          <td colspan="2">Area Details </td>
        </tr>
        <tr>
          <td colspan="2"><textarea name="t3" id="t3"></textarea></td>
        </tr>
        <tr>
          <td width="137">Payment (Amount)</td>
          <td width="124"><input name="t4" type="text" id="t4" onKeyPress="return numbers(event)"></td>
        </tr>
        <tr>
          <td colspan="2">Payment Details </td>
          </tr>
        <tr>
          <td colspan="2"><textarea name="t5" id="t5"></textarea></td>
        </tr>
        <tr>
