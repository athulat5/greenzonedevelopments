...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	{
	if($s1==$row[0])
		echo "<tr align='center' bgcolor='yellow'><td>$row[0]</td><td>$row[2]</td><td>$row[3]</td><td>$row[4]</td><td>$row[5]</td><td><form action='productdamagelist2_staff.php' method='post'><input type='submit' value='Click'><input type='hidden' name='t1' value='$row[0]'></form></td></tr>";
	else
	echo "<tr align='center'><td>$row[0]</td><td>$row[2]</td><td>$row[3]</td><td>$row[4]</td><td>$row[5]</td><td><form action='productdamagelist2_staff.php' method='post'><input type='submit' value='Click'><input type='hidden' name='t1' value='$row[0]'></form></td></tr>";
	} 
	echo "</table>";
