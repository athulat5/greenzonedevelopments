...
<table width="1297" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="434" valign="top"><p><strong>Confirmation</strong></p>
      ...
      </table>      <form name="form4" onSubmit="return abc()" method="post" action="checkconfirmstatus3.php">
        <table width="390" border="0">
          <tr>
            <td height="23" colspan="2">Terms And Conditions </td>
          </tr>
          <tr>
            <td colspan="2"><textarea name="t2" cols="60" id="t2"></textarea></td>
          </tr>
          <tr>
            <td>Industry Name           
          ...
          <tr>
            <td colspan="2"><input type="submit" name="Submit3" value="Submit">
