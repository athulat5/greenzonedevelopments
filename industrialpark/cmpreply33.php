...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	$s=mysql_query("select * from complaint  where staffid is not null and reply is null and staffid in(select staffid from staff where indid='$indid') and cmpno<>$s1");
	...
	return(false);
      ...
      <table width="412" border="0">
        ...
        <tr>
          <td><textarea name="t2" cols="40" rows="10" id="t2" disabled><?php echo $s2; ?></textarea></td>
        </tr>
        <tr>
          <td><?php
